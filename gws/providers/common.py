...
_BASE_SYSTEM_PROMPT = (
    ...
    "An empty file list means nothing has been built yet. "
    "Evaluate whether the brief's requirements are met by the EXISTING FILES in repo_trees, "
    "not by past work attempts in envelope. "
    "Failed outcomes in envelope mean the work was attempted but did NOT land in the repo. "
    "If repo_trees shows the drop directory already contains files that fulfill the brief, "
    "return the exact string SATISFIED (no quotes, no JSON). "
